...
const DEFAULT_SERVICE_CONFIG: ServiceConfig = {
    platforms: {
        ...
        threads: { id: 'threads', name: 'Threads', enabled: true, method: 'gallery-dl', rateLimit: 10, cacheTime: 300, disabledMessage: 'Threads service is temporarily unavailable.', lastUpdated: new Date().toISOString(), stats: { totalRequests: 0, successCount: 0, errorCount: 0, avgResponseTime: 0 } },
